...
def main(pub_control,pub_config):
    ...
    xd = lambda t: 5 * np.sin(7*0.04 * t) + 0.1
    yd = lambda t: 5 * np.sin(7*0.08 * t) + 0.1
    zd = lambda t: 1 * np.sin(0.08 * t) + 2

    xdp = lambda t: 5 *7* 0.04 * np.cos(7*0.04 * t)
    ydp = lambda t: 5 *7* 0.08 * np.cos(7*0.08 * t)
    zdp = lambda t: 0.08 * np.cos(0.08 * t)

    xdpp = lambda t: -5 *7* 0.04 * 0.04 * np.sin(7*0.04 * t)
    ydpp = lambda t: -5 *7* 0.08 * 0.08 * np.sin(7*0.08 * t)
